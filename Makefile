...
CXX = emcc
CXXFLAGS = -O2 -fno-rtti -msimd128 -msse4.2 $(THREAD_CCXFLAGS) $(FIRSTTIME_CXXFLAGS)
...
LDFLAGS = -sUSE_SDL=2 -sFULL_ES3=1 -sGL_DEBUG=1 -sINITIAL_MEMORY=256Mb -sSTACK_SIZE=1Mb -sWASM=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 $(OPUS_LDFLAGS) $(THREAD_LDFLAGS)
